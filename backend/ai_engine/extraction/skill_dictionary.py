...
SKILL_CATEGORIES: Mapping[str, str] = {
    ...
    "HTML": "Web Technology", "CSS": "Web Technology", "Redux": "Framework", "Context API": "Framework", "Tailwind CSS": "Framework", "Jupyter": "Tool",
...
SKILL_ALIASES: Mapping[str, str] = {
    "py": "Python", "python3": "Python", "js": "JavaScript", "ts": "TypeScript", "html5": "HTML", "css3": "CSS", "nodejs": "Node.js", "node js": "Node.js", "reactjs": "React", "react js": "React", "nextjs": "Next.js", "next js": "Next.js", "tailwind": "Tailwind CSS", "rest api": "REST API", "rest APIs": "REST API", "restful api": "REST API", "restful APIs": "REST API", "contextapi": "Context API", "vuejs": "Vue.js", "vue js": "Vue.js", "postgres": "PostgreSQL", "mssql": "Microsoft SQL Server", "ms sql server": "Microsoft SQL Server", "github": "GitHub", "aws cloud": "AWS", "google cloud": "GCP", "google cloud platform": "GCP", "g cloud": "GCP", "scikit learn": "Scikit-Learn", "sklearn": "Scikit-Learn", "tf": "TensorFlow", "k8s": "Kubernetes", "dotnet": ".NET", "dot net": ".NET", "asp net": "ASP.NET", "c sharp": "C#", "cplusplus": "C++", "c plus plus": "C++",
}
